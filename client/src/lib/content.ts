...
export const caseStudies = [
  ...
  },
  {
    slug: 'i-byco',
    category: 'E-commerce',
    metrics: ['+85% Revenue Growth', '24/7 Tech Support'],
    categoryAr: 'معارض بايكس',
  ...
  },
  {
    ...
    categoryAr: 'معرض قطع غيار سيارات',
  ...
  },
  {
    ...
    categoryAr: 'شركات الخدمات المالية',
    metricsAr: ['تصحيح الملف الائتماني', 'حلول تمويلية'],
    logo: '/images/itc-egypt-logo.png',
  },
  {
    slug: 'future-leading-schools',
    category: 'Schools',
    metrics: ['Private School', 'KG - Primary - Preparatory'],
    categoryAr: 'مدارس',
    metricsAr: ['مدرسة خاصة', 'رياض اطفال - ابتدائى - اعدادى'],
    logo: '/images/future-leading-schools-logo.jpg',
  },
];
...
export const caseStudyNames: Record<string, Record<Language, string>> = {
  ...
  'future-leading-schools': { en: 'Future Leading Private Schools', ar: 'مدارس طلائع المستقبل الخاصة' },
};
...
export const platforms = [
  ...
  { id: 'ecommerce', name: 'E-Commerce', nameAr: 'متاجر إلكترونية', icon: 'ShoppingCart', isNew: true },
...
export const pricingItems = [
  {
    ...
    nameAr: 'موظف المبيعات الذكي',
    descEn: 'Instant response & customer persuasion',
    descAr: 'رد فوري وإقناع العملاء',
    price: 1500,
    platforms: ['facebook', 'whatsapp', 'instagram', 'telegram', 'website'],
    features: [
  ...
  },
  {
    ...
    nameAr: 'خدمة مخصصة',
    descEn: 'A solution built specifically for your business needs',
    descAr: 'حل مصمم خصيصاً لاحتياجات عملك',
    price: 0,
    isContactCard: true,
    platforms: ['custom'],
    features: [
    ...
    featuresAr: [
      'مساعد ذكاء اصطناعي مخصص بالكامل',
      'مصمم حسب سير عملك بالضبط',
      'دعم مخصص وتدريب شامل',
      'أسعار مرنة حسب نطاق العمل',
    ],
  },
  {
    id: 'ecommerce-orders',
    nameEn: 'Order Management & Shipping',
    nameAr: 'إدارة الطلبات والشحن',
    descEn: 'Automated order confirmation, follow-up & shipping integration',
    descAr: 'تأكيد الطلبات تلقائياً ومتابعة العملاء والربط مع شركات الشحن',
    price: 0,
    isContactCard: true,
    featured: true,
    platforms: ['ecommerce'],
    features: [
      'Auto order confirmation via WhatsApp',
      'Customer follow-up & satisfaction',
      'Shipping companies integration',
    ],
    featuresAr: [
      'تأكيد الطلبات تلقائياً عبر واتساب',
      'متابعة العملاء ورضا العملاء',
